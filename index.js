...
const vcard = 'BEGIN:VCARD\n' 
            + 'VERSION:3.0\n' 
            + 'FN:Septz Admin\n' 
            + 'ORG: Pengembang Septz X Bot;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=628992538819:+62 899-2538-819\n' 
            + 'END:VCARD' 
prefix = '#'
blocked = []          
/*********** LOAD FILE ***********/
...
const client = new WAConnection()
   ...
   console.log(color('[','white'),color('∆','red'),color(']','white'),color('qr already scan.subscribe','white'),color('YOU','red'),color('TUBE','white'),color('Its Septz','yellow'))
})
...
client.on('group-participants-update', async (anu) => {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["628992538819@s.whatsapp.net"] 
